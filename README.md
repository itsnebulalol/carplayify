...
▶️ Make most apps work with CarPlay with TrollStore
...
* If you have made a fork before, click fetch upstream then fetch and merge
   * This should be done every time you want to CarPlayify an IPA
...
CarPlayify is licensed under the BSD-3-Clause license, and can be found [here](https://github.com/itsnebulalol/carplayify/blob/main/LICENSE).
